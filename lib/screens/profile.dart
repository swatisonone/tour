...
import 'package:tour/models/post.dart';
import 'package:tour/posts/fab_container.dart';
import 'package:tour/screens/login_screen.dart';
import 'package:tour/screens/screens/edit_profile.dart';
import 'package:tour/screens/screens/list_posts.dart';
import 'package:tour/utils/firebase.dart';
import 'package:tour/widgets/post_tiles.dart';

import '../models/user.dart';
import 'screens/stream_grid_wrapper.dart';
...
class _ProfileState extends State<Profile> {
  ...
  checkIfFollowing() async {
    ...
    if (doc.exists) {
      ...
      // Collection or document doesn't exist, handle accordingly
      // For example, set default values or create the collection/document
      setState(() {
        isFollowing = false; // Assuming default is not following
      });
    }
  }
